...
const Banner = () => {
  return (
    <div className='flex flex-col md:flex-row-reverse py-16 justify-between items-center gap-12 px-4'>
        ...
        <div className='md:w-1/2 w-full '>
            ...
            <button className='bg-amber-300 rounded-2xl p-2'>Subscribe</button>
        </div>
